...
Download the depth-anything model [here](https://drive.google.com/file/d/1iBnVjqLkOpLxtRsbD7uGchW4RWvUuuFN/view?usp=drive_link). Create a checkpoints folder with the path:

```
./ANNEXE/MiniGPT-4/minigpt4/models/checkponits/
```

Put the downloaded depth-anything model in this folder.
