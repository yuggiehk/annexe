...
class RunnerBase:
    ...
    def train_loader(self):
        ...
        print(train_dataloader, self.dataloaders)
    ...
    def train(self):
        ...
        for cur_epoch in range(self.start_epoch, self.max_epoch):
            ...
            # evaluation phase
            if cur_epoch % 1 == 0 and len(self.valid_splits) > 0:
    ...
    @torch.no_grad()
    def eval_epoch(self, split_name, cur_epoch, skip_reload=False, dataset=None):
        """
        ...
        # results = self.task.evaluation(model)
            ...
            if isinstance(dataset, list) or isinstance(dataset, tuple) :
                ...
                if hasattr(dataset[0], 'sample_ratio') and dataset_ratios is None:
                    ...
                    if is_train:
                        ...
                        loader = [_create_loader(d, num_workers, bsz[i], is_train, collate_fn[i][0])
                                for i, d in enumerate(dataset)
                            ]
                else:
    ...
    def _reload_best_model(self, model):
        ...
        """
        checkpoint_path = os.path.join(self.output_dir, "checkpoint_newest.pth")
