...
from .egoirgbench_builder import EgoIRGBenchDatasetBuilder

@registry.register_builder("egoirgbench")
class EGOINTERBuilder(EgoIRGBenchDatasetBuilder):
    train_dataset_cls = EgoIRGBenchDataset
    eval_dataset_cls = EgoIRGBenchDataset

    DATASET_CONFIG_DICT = {
        "default": "/home/suyuejiao/MiniGPT-4/minigpt4/configs/datasets/egoirgbench/config.yaml"
    }
